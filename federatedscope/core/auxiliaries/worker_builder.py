...
def get_client_cls(cfg):
    ...
    Note:
      The key-value pairs of client type and source:
        ...
        ``myfedsageplus``      ``gfl.myfedsageplus.worker.FedSagePlusClient``
        ``feddep``      ``gfl.feddep.worker.FedDEPClient``
    ...
    elif client_type == 'myfedsageplus':
        from federatedscope.gfl.myfedsageplus.worker import FedSagePlusClient
        client_class = FedSagePlusClient
    elif client_type == 'feddep':
        from federatedscope.gfl.feddep.worker import FedDEPClient
        client_class = FedDEPClient
...
def get_server_cls(cfg):
    ...
    Note:
      The key-value pairs of server type and source:
        ...
        ``myfedsageplus``      ``gfl.myfedsageplus.worker.FedSagePlusServer``
        ``feddep``      ``gfl.feddep.worker.FedDEPServer``
    ...
    elif server_type == 'myfedsageplus':
        from federatedscope.gfl.myfedsageplus.worker import FedSagePlusServer
        server_class = FedSagePlusServer
    elif server_type == 'feddep':
        from federatedscope.gfl.feddep.worker import FedDEPServer
        server_class = FedDEPServer
