...
def extend_fl_algo_cfg(cfg):
    ...
    # test
    cfg.fedsageplus.test = 32

    # ---------------------------------------------------------------------- #
    # myFedSage+ related options, gfl
    # ---------------------------------------------------------------------- #
    cfg.myfedsageplus = CN()

    # Number of nodes generated by the generator
    cfg.myfedsageplus.num_pred = 5
    # Hidden layer dimension of generator
    cfg.myfedsageplus.gen_hidden = 128
    # Hide graph portion
    cfg.myfedsageplus.hide_portion = 0.5
    # Federated training round for generator
    cfg.myfedsageplus.fedgen_epoch = 200
    # Local pre-train round for generator
    cfg.myfedsageplus.loc_epoch = 1
    # Coefficient for criterion number of missing node
    cfg.myfedsageplus.a = 1.0
    # Coefficient for criterion feature
    cfg.myfedsageplus.b = 1.0
    # Coefficient for criterion classification
    cfg.myfedsageplus.c = 1.0
    cfg.myfedsageplus.test = 32
